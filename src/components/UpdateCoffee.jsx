...
const UpdateCoffee = () => {
    ...
    return (
        <div className="bg-[#F4F3F0] p-24 ">
            <h2 className="text-3xl font-semibold text-center mb-5">Update coffee: {name}</h2>
                ...
                <div className="mb-6">
                    <div className="w-full">
                        <label className="form-control">
                            ...
                            <input type="text" name="photoUrl" defaultValue={photoUrl} placeholder="Enter coffee photo url" className="input input-bordered w-full" />
                        </label>
                    </div>
                </div>
